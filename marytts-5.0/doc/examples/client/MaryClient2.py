...
class MaryClient:
    ...
    def __init__( self, host="cling.dfki.uni-sb.de", port=59125, profile=False, quiet=False ):
        ...
        if not self.quiet:
            ...
            try:
                info = self.getServerVersionInfo() if False else ''
            except:
...
if __name__ == '__main__':
    ...
    serverHost = "localhost" #"cling.dfki.uni-sb.de"
    serverPort = 59125
    inputType = "TEXT"
    ...
    #print maryClient.getServerExampleText('PHONEMES')
    print dir(maryClient)
    print maryClient.getAvailableLanguages()
    #print maryClient.process( input, inputType, outputType, audioType, defaultVoice, outputFile )
